...
/** Surface de trace pour tester la convexification. */
public class ExoCvxPol extends ExoView
{
  ...
  public void paint (Graphics g)
  {
    ...
    Polygone[] cvx = pol.convexes ();
    for (int i = 0; i < cvx.length; i++)
    {
      Segment[] aretes = cvx[i].aretes ();
